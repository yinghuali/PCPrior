...
# nohup python get_point_mutants_feature.py --path_target_model '/home/yinghua/pycharm/PCPrior/target_models/s3dis_pointnet2_msg_8.pt' --path_x_all_mutants '/raid/yinghua/PCPrior/pkl_data/s3dis/x_all_mutants.pkl' --path_y '/raid/yinghua/PCPrior/pkl_data/s3dis/y.pkl' --save_train_point_mutants_feature_vec '/raid/yinghua/PCPrior/pkl_data/s3dis/pointnet2_msg_8_train_point_mutants_feature_vec.pkl' --save_test_point_mutants_feature_vec '/raid/yinghua/PCPrior/pkl_data/s3dis/pointnet2_msg_8_test_point_mutants_feature_vec.pkl' --path_target_train_pre '/raid/yinghua/PCPrior/pkl_data/s3dis_pre/s3dis_pre_pointnet2_msg_8_train_pre.pkl' --path_target_test_pre '/raid/yinghua/PCPrior/pkl_data/s3dis_pre/s3dis_pre_pointnet2_msg_8_test_pre.pkl' > /dev/null 2>&1 &
